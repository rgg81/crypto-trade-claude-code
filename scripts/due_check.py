"""Hourly-poll due-gate CLI for the Operation TEMPEST loop.

The cron fires every hour at :07; this is the FIRST action each fire. It decides whether the
current 4h candle still needs a cycle and prints ONE of:
